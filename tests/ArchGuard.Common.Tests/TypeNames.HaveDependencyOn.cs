namespace ArchGuard.Tests.Common.Types
{
    public static partial class TypeNames
    {
        ...
        {
            public const string PublicClass = Namespaces.HaveDependencyOn + "." + nameof(PublicClass);
            ...
            public const string PublicDependsOnMethodBodyStaticCallClass =
                Namespaces.HaveDependencyOn + "." + nameof(PublicDependsOnMethodBodyStaticCallClass);
            ...
            public const string PublicDependsOnMethodBodyCallingStaticConstructorClass =
                Namespaces.HaveDependencyOn + "." + nameof(PublicDependsOnMethodBodyCallingStaticConstructorClass);
