namespace ArchGuard.Tests.Common.Types
{
    public static partial class TypeNames
    {
        ...
        {
            public const string FileClass = Namespaces.Public + "." + nameof(FileClass);

            public const string FileEnum = Namespaces.Public + "." + nameof(FileEnum);

            public const string IFileInterface = Namespaces.Public + "." + nameof(IFileInterface);

            public const string InternalClass = Namespaces.Public + "." + nameof(InternalClass);
