namespace ArchGuard.Filters.Tests
{
    ...
    public sealed class StaticlessTests
    {
        ...
        public void AreStaticless()
        {
            ...
            // Assert
            types.Should().BeEquivalentTo(TypeNames.Staticless.PublicStaticlessClass.ToListString());
        }
        ...
        public void AreNotStaticless()
        {
            ...
            // Assert
            types.Should().BeEquivalentTo(TypeNames.Staticless.PublicNonStaticlessClass.ToListString());
        }
    }
}
